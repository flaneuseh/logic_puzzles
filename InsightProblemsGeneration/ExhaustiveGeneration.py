...
class ExtGenerator():
                ...
                for alt in sub_grammar:
                    ...
                    for token in alt:
                        if token in Grammar.TERMINALS:
                            ...
                            token_words = ExtGenerator.expand_grammar(Grammar.sub_grammar(grand_grammar, token), grand_grammar)
                            duped_alt_words = []
    ...
    def generate_nonredundant_clues(puzzle):
        ...
        two_three_term_sets = ExtGenerator.__generate_nonredundant_two_three_term_lists(puzzle.categories)
        clues["before"] = ExtGenerator.__generate_nonredundant_clues__before(deepcopy(two_three_term_sets))
        clues["simple_or"] = ExtGenerator.__generate_nonredundant_clues__simple_or(deepcopy(two_three_term_sets))
    ...
    def gen_clues_dict(puzzle, by_type=False):
        ...
        soln_clues_by_type_dict = ExtGenerator.generate_solution_clues_dict(clues_by_type, solutions)
        if by_type:
